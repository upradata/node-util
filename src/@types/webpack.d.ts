...
export declare class AggressiveMergingPlugin {
...
export declare class AggressiveSplittingPlugin {
...
export declare interface AggressiveSplittingPluginOptions {
    /**
...
export declare interface ArgumentConfig {
    description: string;
    path: string;
    multiple: boolean;
...
export declare interface AssetEmittedInfo {
    content: Buffer;
    source: Source;
...
export declare abstract class AsyncDependenciesBlock extends DependenciesBlock {
    groupOptions: {
        preloadOrder?: number;
...
export declare abstract class AsyncQueue<T, K, R> {
    hooks: {
...
export declare class AsyncWebAssemblyModulesPlugin {
    constructor(options?: any);
    options: any;
...
export declare class AutomaticPrefetchPlugin {
    constructor();
...
export declare interface BannerPluginOptions {
    /**
...
export declare interface BaseResolveRequest {
    path: DevTool;
...
export declare abstract class BasicEvaluatedExpression {
    type: number;
    range: [ number, number ];
    falsy: boolean;
    truthy: boolean;
...
export declare abstract class ByTypeGenerator extends Generator {
    map: any;
}
...
export declare abstract class CacheFacade {
...
export declare interface CacheGroupSource {
    key?: string;
    priority?: number;
    getName?: (
        module?: Module,
...
export declare interface CacheGroupsContext {
    moduleGraph: ModuleGraph;
    chunkGraph: ChunkGraph;
}
type CacheOptionsNormalized = false | MemoryCacheOptions | FileCacheOptions;
export declare class CachedSource extends Source {
...
export declare interface CallExpressionInfo {
    type: "call";
    call: CallExpression;
    calleeName: string;
...
export declare interface CallbackCache<T> {
    (err?: WebpackError, result?: T): void;
}
export declare interface CallbackFunction<T> {
    (err?: Error, result?: T): any;
}
export declare interface CallbackNormalErrorCache<T> {
    (err?: Error, result?: T): void;
}
export declare interface CallbackWebpack<T> {
...
export declare abstract class ChunkGroup {
    groupDebugId: number;
...
export declare interface ChunkGroupOptions {
    preloadOrder?: number;
    prefetchOrder?: number;
    name?: string;
}
export declare interface ChunkHashContext {
    /**
...
export declare interface ChunkMaps {
    hash: Record<string | number, string>;
    contentHash: Record<string | number, Record<string, string>>;
    name: Record<string | number, string>;
}
export declare class ChunkModuleIdRangePlugin {
    constructor(options?: any);
    options: any;
...
export declare interface ChunkModuleMaps {
    id: Record<string | number, (string | number)[]>;
    hash: Record<string | number, string>;
}
export declare interface ChunkPathData {
    id: string | number;
    name?: string;
    hash: string;
...
export declare class ChunkPrefetchPreloadPlugin {
    constructor();
    apply(compiler: Compiler): void;
}
export declare interface ChunkSizeOptions {
    /**
...
export declare abstract class ChunkTemplate {
    hooks: Readonly<{
...
export declare interface CodeGenerationContext {
    /**
...
export declare interface CodeGenerationResult {
    /**
...
export declare abstract class CodeGenerationResults {
...
export declare interface Comparator<T> {
    (arg0: T, arg1: T): 0 | 1 | -1;
}
export declare class CompatSource extends Source {
...
export declare interface CompilationHooksAsyncWebAssemblyModulesPlugin {
    renderModuleContent: SyncWaterfallHook<[ Source, Module, RenderContextObject ]>;
}
export declare interface CompilationHooksJavascriptModulesPlugin {
    renderModuleContent: SyncWaterfallHook<[ Source, Module, RenderContextObject ]>;
...
export declare interface CompilationHooksRealContentHashPlugin {
    updateHash: SyncBailHook<[ Buffer[], string ], string>;
}
export declare interface CompilationParams {
...
export declare class ConcatSource extends Source {
    constructor(...args: (string | Source)[]);
    getChildren(): Source[];
    add(item: string | Source): void;
    addAllSkipOptimizing(items: Source[]): void;
}
export declare interface ConcatenatedModuleInfo {
    index: number;
    module: Module;
...
export declare interface ConcatenationBailoutReasonContext {
    /**
     * the module graph
     */
    moduleGraph: ModuleGraph;
...
export declare class ConcatenationScope {
    constructor(
...
export declare class ConsumeSharedPlugin {
 ...
 */
export declare interface ConsumeSharedPluginOptions {
    /**
 ...
 */
export declare interface ConsumesConfig {
    /**
...
export declare interface ContainerPluginOptions {
    /**
...
export declare class ContainerReferencePlugin {
...
export declare interface ContainerReferencePluginOptions {
    /**
...
export declare abstract class ContextElementDependency extends ModuleDependency {
    referencedExports: any;
}
export declare class ContextExclusionPlugin {
...
type ContextMode =
    ...
    | "lazy"
    | "lazy-once";
export declare abstract class ContextModuleFactory extends ModuleFactory {
    hooks: Readonly<{
...
export declare interface ContextModuleOptions {
    mode: ContextMode;
    recursive: boolean;
    regExp: RegExp;
...
export declare class ContextReplacementPlugin {
    constructor(
        resourceRegExp?: any,
...
export declare class DefinePlugin {
    /**
...
export declare class DelegatedPlugin {
    constructor(options?: any);
    options: any;
...
export declare interface DepConstructor {
    new(...args: any[]): Dependency;
}
export declare abstract class DependenciesBlock {
...
export declare interface DependenciesBlockLike {
    dependencies: Dependency[];
    blocks: AsyncDependenciesBlock[];
}
...
export declare abstract class DependencyTemplate {
    apply(
        dependency: Dependency,
...
export declare interface DependencyTemplateContext {
    /**
     * the runtime template
     */
    runtimeTemplate: RuntimeTemplate;
...
export declare abstract class DependencyTemplates {
...
export declare class DeterministicChunkIdsPlugin {
    constructor(options?: any);
    options: any;
...
export declare class DeterministicModuleIdsPlugin {
    constructor(options?: any);
    options: any;
...
export declare interface DllPluginOptions {
    /**
     * Context of requests in the manifest file (defaults to the webpack context).
     */
    context?: string;
 ...
 * The mappings from request to module info.
 */
export declare interface DllReferencePluginOptionsContent {
    [ index: string ]: {
        /**
 ...
 */
export declare interface DllReferencePluginOptionsManifest {
    /**
     * The mappings from request to module info.
     */
    content: DllReferencePluginOptionsContent;
...
export declare class DynamicEntryPlugin {
...
export declare class ElectronTargetPlugin {
...
export declare class EnableChunkLoadingPlugin {
...
export declare class EnableLibraryPlugin {
    constructor(type: string);
    type: string;
...
type Entry =
    ...
    | EntryObject
    | string[];
export declare interface EntryData {
    /**
...
export declare abstract class EntryDependency extends ModuleDependency { }
 ...
 * An object with entry point description.
 */
export declare interface EntryDescriptionNormalized {
    /**
     * The method of loading chunks (methods included by default are 'jsonp' (web), 'importScripts' (WebWorker), 'require' (sync node.js), 'async-node' (async node.js), but others might be added by plugins).
     */
    chunkLoading?: string | false;
...
type EntryOptions = { name?: string; } & Pick<
    ...
    | "wasmLoading"
>;
export declare class EntryPlugin {
    /**
 ...
 */
export declare interface EntryStaticNormalized {
    [ index: string ]: EntryDescriptionNormalized;
}
export declare abstract class Entrypoint extends ChunkGroup {
    /**
...
export declare class EnvironmentPlugin {
...
export declare class EvalDevToolModulePlugin {
    constructor(options?: any);
    namespace: any;
...
export declare abstract class ExportInfo {
    name: string;
...
export declare interface ExportSpec {
    /**
...
export declare abstract class ExportsInfo {
...
export declare interface ExportsSpec {
    /**
...
type Expression =
    ...
    | ImportExpression
    | ChainExpression;
export declare interface ExpressionExpressionInfo {
    type: "expression";
    rootInfo: string | VariableInfo;
    name: string;
    getMembers: () => string[];
...
export declare class ExternalModule extends Module {
...
export declare interface ExternalModuleInfo {
    index: number;
    module: Module;
}
type Externals =
...
export declare class ExternalsPlugin {
 ...
 * Enable presets of externals for specific targets.
 */
export declare interface ExternalsPresets {
    /**
...
type ExternalsType =
    ...
    | "import"
    | "script";
export declare interface FactorizeModuleOptions {
...
export declare interface FakeHookMarker { }
export declare interface FallbackCacheGroup {
    minSize: Record<string, number>;
    maxAsyncSize: Record<string, number>;
    maxInitialSize: Record<string, number>;
    automaticNameDelimiter: string;
}
export declare class FetchCompileAsyncWasmPlugin {
    constructor();
...
export declare class FetchCompileWasmPlugin {
    constructor(options?: any);
    options: any;
 ...
 */
export declare interface FileCacheOptions {
    /**
...
export declare interface FileSystemCallback<T> {
    (err?: null | (PossibleFileSystemError & Error), result?: T): any;
}
export declare interface FileSystemDirent {
    name: string | Buffer;
    isDirectory: () => boolean;
    isFile: () => boolean;
}
export declare abstract class FileSystemInfo {
    fs: InputFileSystem;
    logger?: WebpackLogger;
...
export declare interface FileSystemInfoEntry {
    safeTime: number;
    timestamp?: number;
...
export declare interface GenerateContext {
    /**
...
export declare class GetChunkFilenameRuntimeModule extends RuntimeModule {
    constructor(
        contentType: string,
        name: string,
        global: string,
...
export declare interface GroupConfig<T, R> {
...
export declare interface HMRJavascriptParserHooks {
    hotAcceptCallback: SyncBailHook<[ any, string[] ], void>;
    hotAcceptWithoutCallback: SyncBailHook<[ any, string[] ], void>;
}
export declare interface HandleModuleCreationOptions {
    factory: ModuleFactory;
    dependencies: Dependency[];
    originModule: null | Module;
    context?: string;
...
export declare interface HashableObject {
    updateHash: (arg0: Hash) => void;
}
export declare class HashedModuleIdsPlugin {
    constructor(options?: HashedModuleIdsPluginOptions);
    options: HashedModuleIdsPluginOptions;
    apply(compiler?: any): void;
}
export declare interface HashedModuleIdsPluginOptions {
    /**
...
export declare abstract class HelperRuntimeModule extends RuntimeModule { }
export declare class HotModuleReplacementPlugin {
    constructor(options?: any);
    options: any;
...
export declare class HotUpdateChunk extends Chunk {
    constructor();
}
export declare class HttpUriPlugin {
    constructor();
...
export declare class HttpsUriPlugin {
    constructor();
...
export declare class IgnorePlugin {
 ...
 * Options for infrastructure level logging.
 */
export declare interface InfrastructureLogging {
    /**
...
export declare abstract class InitFragment {
...
export declare interface InputFileSystem {
    readFile: (
        arg0: string,
...
export declare interface IntermediateFileSystemExtras {
...
export declare abstract class ItemCacheFacade {
...
export declare class JavascriptModulesPlugin {
    constructor(options?: {});
    options: {};
...
export declare class JsonpChunkLoadingRuntimeModule extends RuntimeModule {
...
export declare interface JsonpCompilationPluginHooks {
    linkPreload: SyncWaterfallHook<[ string, Chunk ]>;
    linkPrefetch: SyncWaterfallHook<[ string, Chunk ]>;
}
export declare class JsonpTemplatePlugin {
    constructor();
...
export declare interface KnownAssetInfo {
    /**
...
export declare interface KnownBuildMeta {
...
export declare abstract class LazySet<T> {
...
export declare interface LibIdentOptions {
    /**
...
export declare interface LibraryContext<T> {
    compilation: Compilation;
    options: T;
}
 ...
 */
export declare interface LibraryCustomUmdCommentObject {
    /**
 ...
 */
export declare interface LibraryCustomUmdObject {
    /**
...
export declare class LibraryTemplatePlugin {
    constructor(
        name: LibraryName,
        target: string,
        umdNamedDefine: boolean,
...
export declare class LimitChunkCountPlugin {
    constructor(options?: LimitChunkCountPluginOptions);
    options?: LimitChunkCountPluginOptions;
    apply(compiler: Compiler): void;
}
export declare interface LimitChunkCountPluginOptions {
    /**
     * Constant overhead for a chunk.
     */
    chunkOverhead?: number;
...
export declare interface LoadScriptCompilationHooks {
    createScript: SyncWaterfallHook<[ string, Chunk ]>;
}
export declare class LoadScriptRuntimeModule extends HelperRuntimeModule {
    constructor();
    static getCompilationHooks(
        compilation: Compilation
...
export declare interface LoaderItem {
    loader: string;
    options: any;
    ident: null | string;
    type: null | string;
...
export declare interface LoaderOptionsPluginOptions {
    [ index: string ]: any;
...
export declare const MEASURE_END_OPERATION: unique symbol;
export declare const MEASURE_START_OPERATION: unique symbol;
export declare interface MainRenderContext {
    /**
     * the chunk
     */
    chunk: Chunk;
...
export declare abstract class MainTemplate {
    hooks: Readonly<{
        renderManifest: { tap: (options?: any, fn?: any) => void; };
        modules: { tap: () => never; };
        moduleObj: { tap: () => never; };
...
export declare class MemoryCachePlugin {
    constructor();
...
export declare class MinChunkSizePlugin {
...
export declare interface MinChunkSizePluginOptions {
    /**
     * Constant overhead for a chunk.
     */
    chunkOverhead?: number;
...
export declare class Module extends DependenciesBlock {
...
export declare class ModuleConcatenationPlugin {
    constructor(options?: any);
    options: any;
...
export declare abstract class ModuleDependency extends Dependency {
    request: string;
    userRequest: string;
    range: any;
}
export declare abstract class ModuleFactory {
    create(
        data: ModuleFactoryCreateData,
        callback: (arg0?: Error, arg1?: ModuleFactoryResult) => void
    ): void;
}
export declare interface ModuleFactoryCreateData {
    contextInfo: ModuleFactoryCreateDataContextInfo;
    resolveOptions?: ResolveOptionsWebpackOptions;
    context: string;
    dependencies: Dependency[];
}
export declare interface ModuleFactoryCreateDataContextInfo {
    issuer: string;
    compiler: string;
}
export declare interface ModuleFactoryResult {
    /**
...
export declare interface ModulePathData {
    id: string | number;
    hash: string;
    hashWithLength?: (arg0: number) => string;
}
export declare abstract class ModuleProfile {
    startTime: number;
    factory: number;
    restoring: number;
    integration: number;
...
export declare interface ModuleReferenceOptions {
    /**
     * the properties/exports of the module
     */
    ids: string[];
...
export declare abstract class ModuleTemplate {
    type: string;
    hooks: Readonly<{
...
export declare abstract class MultiStats {
    stats: Stats[];
    readonly hash: string;
    hasErrors(): boolean;
    hasWarnings(): boolean;
...
export declare abstract class MultiWatching {
    watchings: Watching[];
...
export declare class NamedChunkIdsPlugin {
    constructor(options?: any);
    delimiter: any;
    context: any;
...
export declare class NamedModuleIdsPlugin {
    constructor(options?: any);
    options: any;
...
export declare class NaturalModuleIdsPlugin {
    constructor();
...
export declare interface NeedBuildContext {
    fileSystemInfo: FileSystemInfo;
}
export declare class NoEmitOnErrorsPlugin {
    constructor();
...
export declare class NodeSourcePlugin {
    constructor();
...
export declare class NodeTemplatePlugin {
    constructor(options?: any);
...
export declare class NormalModule extends Module {
    constructor(__0: {
        /**
         * module type
         */
...
export declare interface NormalModuleCompilationHooks {
...
export declare abstract class NormalModuleFactory extends ModuleFactory {
    hooks: Readonly<{
...
export declare interface ObjectDeserializerContext {
    read: () => any;
}
export declare interface ObjectSerializer {
    serialize: (arg0: any, arg1: ObjectSerializerContext) => void;
    deserialize: (arg0: ObjectDeserializerContext) => any;
}
export declare interface ObjectSerializerContext {
    write: (arg0?: any) => void;
}
export declare class OccurrenceChunkIdsPlugin {
...
export declare interface OccurrenceChunkIdsPluginOptions {
    /**
     * Prioritise initial size over total size.
     */
    prioritiseInitial?: boolean;
}
export declare class OccurrenceModuleIdsPlugin {
...
export declare interface OccurrenceModuleIdsPluginOptions {
    /**
     * Prioritise initial size over total size.
     */
    prioritiseInitial?: boolean;
 ...
 */
export declare interface OptimizationSplitChunksCacheGroup {
    /**
...
export declare abstract class OptionsApply {
    process(options?: any, compiler?: any): void;
}
export declare interface OriginRecord {
    module: Module;
    loc: DependencyLocation;
    request: string;
}
export declare class OriginalSource extends Source {
...
export declare interface OutputFileSystem {
    writeFile: (
        arg0: string,
        arg1: string | Buffer,
        arg2: (arg0?: NodeJS.ErrnoException) => void
 ...
 */
export declare interface OutputNormalized {
    /**
     * The filename of asset modules as relative path inside the `output.path` directory.
     */
    assetModuleFilename?:
...
export declare interface ParameterizedComparator<TArg, T> {
    (arg0: TArg): Comparator<T>;
}
export declare interface ParsedIdentifier {
    request: string;
    query: string;
    fragment: string;
    directory: boolean;
...
export declare interface ParserStateBase {
...
export declare interface PnpApiImpl {
    resolveToUnqualified: (arg0: string, arg1: string, arg2?: any) => string;
}
export declare interface PossibleFileSystemError {
    code?: string;
    errno?: number;
    path?: string;
    syscall?: string;
}
export declare class PrefetchPlugin {
...
export declare class PrefixSource extends Source {
    constructor(prefix: string, source: string | Source);
    original(): Source;
    getPrefix(): string;
}
export declare interface PrintedElement {
    element: string;
    content: string;
}
export declare interface Problem {
    type: ProblemType;
    path: string;
    argument: string;
    value?: any;
...
type ProblemType =
    ...
    | "invalid-value";
export declare interface ProcessAssetsAdditionalOptions {
...
export declare interface ProfilingPluginOptions {
    /**
...
export declare class ProvideSharedPlugin {
...
export declare interface ProvideSharedPluginOptions {
    /**
 ...
 */
export declare interface ProvidesConfig {
    /**
 ...
 */
export declare interface ProvidesObject {
    [ index: string ]: string | ProvidesConfig;
}
export declare interface RawChunkGroupOptions {
    preloadOrder?: number;
    prefetchOrder?: number;
}
export declare class RawSource extends Source {
    constructor(source: string | Buffer, convertToString?: boolean);
    isBuffer(): boolean;
}
export declare class ReadFileCompileWasmPlugin {
    constructor(options?: any);
    options: any;
...
export declare class RealContentHashPlugin {
...
type RecursiveArrayOrRecord<T> =
    ...
    | T;
export declare interface ReferencedExport {
    /**
...
export declare interface RenderBootstrapContext {
    /**
     * the chunk
     */
    chunk: Chunk;
...
export declare interface RenderContextModuleTemplate {
    /**
     * the chunk
     */
    chunk: Chunk;
...
export declare interface RenderContextObject {
    /**
     * the chunk
     */
    chunk: Chunk;
...
export declare interface RenderManifestEntryStatic {
    render: () => Source;
    filename: string;
    info: AssetInfo;
    identifier: string;
...
export declare interface RenderManifestEntryTemplated {
    render: () => Source;
...
export declare interface RenderManifestOptions {
    /**
...
export declare class ReplaceSource extends Source {
...
export declare abstract class RequestShortener {
    contextify: (arg0: string) => string;
    shorten(request?: null | string): undefined | null | string;
}
export declare interface ResolveBuildDependenciesResult {
    /**
     * list of files
     */
    files: Set<string>;
...
export declare interface ResolveOptionsTypes {
    alias: {
        /**
         * New request.
         */
 ...
 */
export declare interface ResolveOptionsWebpackOptions {
    /**
 ...
 * Options object for resolving requests.
 */
export declare interface ResolveOptionsWithDependencyType {
    /**
     * Redirect module requests.
     */
    alias?:
 ...
 * Plugin instance.
 */
export declare interface ResolvePluginInstance {
    [ index: string ]: any;
...
export declare interface ResolverCache {
    direct: WeakMap<Object, ResolverWithOptions>;
    stringified: Map<string, ResolverWithOptions>;
}
export declare abstract class ResolverFactory {
    hooks: Readonly<{
...
export declare interface ResourceDataWithData {
    resource: string;
    path: string;
    query: string;
    fragment: string;
 ...
 */
export declare interface RuleSetRule {
    /**
...
type RuleSetUseItem =
    ...
    | __TypeWebpackOptions;
export declare class RuntimeChunkPlugin {
    constructor(options?: any);
    options: any;
...
export declare class RuntimeModule extends Module {
...
export declare abstract class RuntimeSpecMap<T> {
...
export declare abstract class RuntimeSpecSet {
    add(runtime?: any): void;
    has(runtime?: any): boolean;
    [ Symbol.iterator ](): IterableIterator<RuntimeSpec>;
    readonly size: number;
}
export declare abstract class RuntimeTemplate {
    outputOptions: OutputNormalized;
    requestShortener: RequestShortener;
...
export declare abstract class RuntimeValue {
    fn: any;
...
export declare interface Selector<A, B> {
    (input: A): B;
}
 ...
 */
export declare interface SharePluginOptions {
    /**
     * Share scope name used for all shared modules (defaults to 'default').
     */
    shareScope?: string;
...
export declare class SideEffectsFlagPlugin {
...
export declare class SizeOnlySource extends Source {
...
export declare abstract class SortableSet<T> extends Set<T> {
    /**
...
export declare interface SourceData {
    iife?: boolean;
    init?: string;
    expression: string;
}
export declare interface SourceLike {
    source(): string | Buffer;
}
...
export declare class SourceMapSource extends Source {
    constructor(
        source: string | Buffer,
        name: string,
...
export declare interface SplitChunksOptions {
    chunksFilter: (chunk: Chunk) => boolean;
    defaultSizeTypes: string[];
    minSize: Record<string, number>;
    minRemainingSize: Record<string, number>;
...
export declare class SplitChunksPlugin {
...
export declare abstract class StackedMap<K, V> {
...
export declare abstract class StatsFactory {
    hooks: Readonly<{
...
export declare abstract class StatsPrinter {
    hooks: Readonly<{
...
type StatsValue =
    ...
    | "verbose"
    | StatsOptions;
export declare interface SyntheticDependencyLocation {
    name: string;
    index?: number;
}
...
export declare interface TimestampAndHash {
    safeTime: number;
    timestamp?: number;
    timestampHash?: string;
    hash: string;
}
export declare const UNDEFINED_MARKER: unique symbol;
export declare interface UpdateHashContextDependency {
    chunkGraph: ChunkGraph;
    runtime: RuntimeSpec;
    runtimeTemplate?: RuntimeTemplate;
}
export declare interface UpdateHashContextGenerator {
    /**
     * the module
     */
    module: NormalModule;
...
export declare interface UserResolveOptions {
    /**
...
export declare abstract class VariableInfo {
    declaredScope: ScopeInfo;
    freeName: string | true;
    tagInfo?: TagInfo;
}
export declare interface VariableInfoInterface {
    declaredScope: ScopeInfo;
    freeName: string | true;
    tagInfo?: TagInfo;
}
export declare interface WatchFileSystem {
    watch: (
        files: Iterable<string>,
        directories: Iterable<string>,
        missing: Iterable<string>,
...
export declare class WatchIgnorePlugin {
...
export declare interface WatchIgnorePluginOptions {
    /**
...
export declare abstract class Watching {
...
export declare class WebWorkerTemplatePlugin {
    constructor();
...
export declare abstract class WebpackLogger {
...
export declare class WebpackOptionsApply extends OptionsApply {
    constructor();
}
export declare class WebpackOptionsDefaulter {
    constructor();
 ...
 */
export declare interface WebpackOptionsNormalized {
    /**
     * Set the value of `require.amd` and `define.amd`. Or disable AMD support.
     */
    amd?: false | { [ index: string ]: any; };
 ...
 * Plugin instance.
 */
export declare interface WebpackPluginInstance {
    [ index: string ]: any;
...
export declare interface WithId {
    id: string | number;
}
export declare interface WithOptions {
    /**
...
type __TypeWebpackOptions = (data: {}) =>
    ...
    | __TypeWebpackOptions
    | RuleSetUseItem[];
export declare function exports(
