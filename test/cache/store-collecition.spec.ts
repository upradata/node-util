import type { CollectionObject, FilePrint, StoreCollection as StoreCollectionType } from '../../src/cache/store-collection';
...
describe('Test suite for StoreCollection', () => {
    ...
    beforeAll(() => {
        mockFs();
        StoreCollection = require('../../src/cache/store-collection').StoreCollection;
    });
